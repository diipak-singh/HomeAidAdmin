...
public class SubCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("sub_cat_images");
        ...
        addCategoryDialog = new Dialog(SubCategoryActivity.this);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(getApplicationContext(), recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onLongItemClick(View view, int position) {
                        deleteSubCategory(catList.get(position).getCatId(),catList.get(position).getCatName());
        ...
        dref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(getApplicationContext(), "No Sub-Categories Added, Add some by pressing + button.", Toast.LENGTH_SHORT).show();
                }
    ...
    private void addNewSubCategory() {
        ...
        dref.child(id).setValue(cm).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isComplete()) {
                    Toast.makeText(getApplicationContext(), "Sub-Category Added Successfully", Toast.LENGTH_SHORT).show();
    ...
    public void deleteSubCategory(final String catId, String catName) {
        dref = FirebaseDatabase.getInstance().getReference().child("subcategories/" + catg);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(SubCategoryActivity.this, "Sub-Category Deleted Successfully", Toast.LENGTH_SHORT).show();
                        adapter.notifyDataSetChanged();
                    }
